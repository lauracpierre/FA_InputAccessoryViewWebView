#
#  Be sure to run `pod spec lint FA_InputAccessoryViewWebView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    UIWebView subclass to provide alternative input accessory view.
  ...
  s.source       = { :git => "https://github.com/lauracpierre/FA_InputAccessoryViewWebView.git", :tag => "v0.0.3" }
